    ...
    <a href="/settings/profile"
      ...
      <div class="content">
        <div class="account-group js-mini-current-user" data-user-id="107085561" data-screen-name="abhishanksahu">
          ...
          <b class="fullname">abhishank sahu</b>
...
<div class="content-main">
  <div class="content-header">
    <div class="header-inner">
      <h2>Account</h2>
      <p class="subheader">Change your basic Details.</p>
    </div>
  </div>
  <div class="content-inner no-stream-end">
    <form id="account-form" class="form-horizontal requires-password" method="POST" action="post_profile_update.php">
	  ...
	  <?php
		$result = mysql_query("SELECT * FROM PROFILE WHERE UNAME='$_SESSION[username]'");
        ...
        "<div class='controls'>".
          ...
          "<input name='fname' maxlength='15' name='user[screen_name]' type='text' value=$row[FNAME]>".
	  ...
	  echo "<fieldset id='username_fieldset' class='control-group'>".
        ...
        '<div class="controls">'.
          '<p id="username_notification" class="notification"></p>'.
          "<input name='lname' maxlength='15' name='user[screen_name]' type='text' value=$lname>".
	  ...
	  '<fieldset id="username_fieldset" class="control-group">'.
        ...
        '<div class="controls">'.
          '<p id="username_notification" class="notification"></p>'.
          "<input name='dob' maxlength='15' name='user[screen_name]' type='text' value=$row[DOB]>".
      ...
      '<fieldset id="email_fieldset" class="control-group">'.
        ...
        '<div class="controls">'.
          ...
          "<input name='email' class='email-input' name='user[email]' type='text' value=$row[EMAIL]>".
          '</div>'.
      '</fieldset>'.
      ...
      '<hr/>'.
       '<fieldset class="control-group">'.
        ...
        '<div class="controls">'.
          '<select name="dept" name="user[lang]">';
				$result1 = mysql_query("SELECT * FROM DEPARTMENT");
				$DEPT = 'DEPT_NAME';
				$dept_id = 'DEPT_ID';
                while ($row1 = mysql_fetch_array($result1)) {
					if($row1['DEPT_ID'] == $row['DEPT_ID'])
						echo "<option value=$row1[$dept_id] selected>$row1[$DEPT]</option>";
					else
						echo "<option value=$row1[$dept_id]>$row1[$DEPT]</option>";
				}
		 echo  '</select>'.
        '</div>'.
      '</fieldset>'.
	  ...
	  '<fieldset id="username_fieldset" class="control-group">'.
		...
		if($row['PROGRAMME'] == "M Tech")
			echo '<option value= "MTECH" selected>M Tech</option>';
		else
			echo '<option value= "MTECH">M Tech</option>';
	...
	'<fieldset id="username_fieldset" class="control-group">'.
        ...
        '<div class="controls">'.
		'<select name="year">';
		echo '<option value ="1"'.($row['YEAR']==1?'selected':'').'>1</option>';
		echo '<option value ="2"'.($row['YEAR']==2?'selected':'').'>2</option>';
		echo '<option value ="3"'.($row['YEAR']==3?'selected':'').'>3</option>';
		echo '<option value ="4"'.($row['YEAR']==4?'selected':'').'>4</option>';
		echo '<option value ="5"'.($row['YEAR']==5?'selected':'').'>5</option>';
		echo '<option value ="6"'.($row['YEAR']==6?'selected':'').'>6</option>';
		echo '</select>'.
        '</div>'.
	'</fieldset>'.
'<hr/>'.
'<fieldset id="username_fieldset" class="control-group">'.
        ...
        '<div class="controls">'.
          '<p id="username_notification" class="notification"></p>'.
          "<input name='mobile' maxlength='15' name='user[screen_name]' type='text' value=$row[MOBILE_NO]>".
...
'<fieldset id="username_fieldset" class="control-group">'.
        ...
        '<div class="controls">'.
          '<select name="sex" name="user[lang]">';
               echo '<option value ="M"'.($row['SEX']=='M'?'selected':'').'>Male</option>';
               echo '<option value ="F"'.($row['SEX']=='F'?'selected':'').'>Female</option>';
	       echo '<option value ="O"'.($row['SEX']=='O'?'selected':'').'>Not Specified</option>';
              echo '</select>'.
        '</div>'.
'</fieldset>'.
'<fieldset class="control-group">'.
        ...
        '<div class="controls">'.
          '<select name="rel_stat" name="user[lang]">'.
	  
               '<option value ="Committed"'.($row['RELATIONSHIP_STATUS']=='Committed'?'selected':'').'>Committed</option>'.
               '<option value ="Single"'.($row['RELATIONSHIP_STATUS']=='Single'?'selected':'').'>Single</option>'.
               '<option value ="Married"'.($row['RELATIONSHIP_STATUS']=='Married'?'selected':'').'>Married</option>'.
	       '<option value ="Complicated"'.($row['RELATIONSHIP_STATUS']=='Complicated'?'selected':'').'>Complicated</option>'.
          '</select>'.
        '</div>'.
      '</fieldset>'.
      '<hr />'.
	  ...
	  echo "<input name='room' maxlength='15' name='user[screen_name]' type='text' value=$row2[ROOM_NO]>";
  echo '</div>'.
'</fieldset>'.
'<fieldset id="username_fieldset" class="control-group">'.
        ...
        '<div class="controls">'.
          '<p id="username_notification" class="notification"></p>'.
          "<input name='hostel' maxlength='15' name='user[screen_name]' type='text' value=$row2[HOSTEL]>".
...
'<h3>About you</h3>'.
      '<fieldset id="username_fieldset" class="control-group">'.
        ...
        '<div class="controls">'.
          '<textarea name="bio">'."$row[BIO]".'</textarea>'.
        '</div>'.
'</fieldset>'.
'<fieldset id="username_fieldset" class="control-group">'.
        ...
        '<div class="controls">'.
          '<p id="username_notification" class="notification"></p>'.
          "<input name='website' maxlength='15' name='user[screen_name]' type='text' value=$row[WEBSITE]>".
        '</div>'.
'</fieldset>'.
   '<hr />';
   ?>
      ...
      <fieldset class="control-group">
        <div class="controls">
          <p><a id="account_deactivate_link" href="/settings/accounts/confirm_deactivation">Deactivate my account</a></p>
        </div>
      </fieldset>
    </form>
  </div>
