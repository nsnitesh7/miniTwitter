    ...
    <form id="account-form" class="form-horizontal requires-password" method="POST" action="https://twitter.com/settings/accounts/update">
	  ...
	  <?php
        ...
        "<div class='controls'>".
          ...
          "<input id='user_screen_name' maxlength='15' name='user[screen_name]' type='text' value=$row[FNAME]>".
	  ...
	  echo "<fieldset id='username_fieldset' class='control-group'>".
        ...
        '<div class="controls">'.
          '<p id="username_notification" class="notification"></p>'.
          "<input id='user_screen_name' maxlength='15' name='user[screen_name]' type='text' value=$lname>".
	  ...
	  '<fieldset id="username_fieldset" class="control-group">'.
        ...
        '<div class="controls">'.
          '<p id="username_notification" class="notification"></p>'.
          "<input id='user_screen_name' maxlength='15' name='user[screen_name]' type='text' value=$row[DOB]>".
      ...
      '<fieldset id="email_fieldset" class="control-group">'.
        ...
        '<div class="controls">'.
          ...
          "<input id='user_email' class='email-input' name='user[email]' type='text' value=$row[EMAIL]>".
          '</div>'.
      '</fieldset>'.
...
'<fieldset id="username_fieldset" class="control-group">'.
        ...
        '<div class="controls">'.
          '<p id="username_notification" class="notification"></p>'.
          "<input id='user_screen_name' maxlength='15' name='user[screen_name]' type='text' value=$row[MOBILE_NO]>".
...
<fieldset id="username_fieldset" class="control-group">
        ...
        <div class="controls">
          <select id="user_lang" name="user[lang]">
               <option value="zh-tw" >Male</option>
               <option value="tr" >Female</option>
...
<fieldset class="control-group">
        ...
        <div class="controls">
          <select id="user_lang" name="user[lang]">
               <option value="zh-tw" >Single</option>
               <option value="tr" >Committed</option>
               <option value="uk" >Complicatted</option>
                       </select>
        </div>
      </fieldset>
      <hr />
